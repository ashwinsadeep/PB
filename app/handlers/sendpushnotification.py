...
cert_file = fn = os.path.join(os.path.dirname(__file__), '../../pushcert.pem')
con = Session().new_connection('push_sandbox', cert_file=cert_file)

message = Message("cc85aa00960e2ec2e870826ae3ada3c3db250d65d4fe05924971e6e351402d5c", alert="My message", badge=10)
